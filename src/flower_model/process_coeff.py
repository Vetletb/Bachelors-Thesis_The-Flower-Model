...
from ._augmentation import _augment_coeff
...
class CoeffProcessor:
    ...
    def process(
        ...
        var_amount = aug_amount*2+2 if aug_amount > 0 else 1
        ...
        for i in range(self.num_batches):
            ...
            if aug_amount > 0:
                current_batch = _augment_coeff(
                    current_batch, aug_amount, self.img_res
                )
                current_batch = current_batch.view(current_batch_size, aug_amount*2+2, -1)
            else:
